...
import gamingPCsHeroImg from '../../../../assets/gamingGearImages/gaming_pcs_images/gaming_pcs_img_hero.avif';
import featuredDealsPcImgOne from '../../../../assets/gamingGearImages/gaming_pcs_images/featured_deals_pc_img_one.avif';
import featuredDealsPcImgTwo from '../../../../assets/gamingGearImages/gaming_pcs_images/featured_deals_pc_img_two.avif';
import pcImage from '../../../../assets/pcImages/AMD Ryzen Ultra Gaming Daily Deal.avif'
            ...
            <div className="gaming-gear-hero-section-pcs">
                <div className="gaming-gear-hero-content">
                    <div className="gaming-gear-hero-section-text">
                        <h2 className="gaming-gear-hero-content-title">Gaming PCs</h2>
                        <p className="gaming-gear-hero-content-subtitle">The best gaming pcs out there.</p>
                    </div>

                    <img src={gamingPCsHeroImg} alt="gaming laptops" className="gaming-gear-hero-content-img" />
                </div>
            </div>
            ...
            <div className="gaming-gear-featured-deals-section">
                ...
                <div className="gaming-gear-featured-deals-section-content">
                    <div className="gaming-gear-featured-deal">
                        <h2 className="gaming-gear-featured-deal-title">AMD Gaming PC Configurator 2 Daily Deal</h2>
                        ...
                        <img src={featuredDealsPcImgOne} alt="Chimera NP7570E Gaming Laptop" className='gaming-gear-featured-deal-img' />
                    </div>

                    <div className="gaming-gear-featured-deal">
                        <h2 className="gaming-gear-featured-deal-title">Intel Core 14th Gen Extreme Gaming Daily Deal</h2>
                        ...
                        <img src={featuredDealsPcImgTwo} alt="Chimera NP9373W Gaming Laptop" className='gaming-gear-featured-deal-img' />
                    </div>
                </div>
            </div>

            <div className="gaming-gear-all-products-section">
                <h2 className="gaming-gear-all-products-section-title">Gaming Pcs</h2>
                    ...
                    <div className="gaming-gear-all-products-section-main">
                        ...
                        <div className="gaming-gear-all-products-section-main-products">
                            <div className="pc-list-item">
                                <img src={pcImage} alt="" className='pc-item-cover-img' />
