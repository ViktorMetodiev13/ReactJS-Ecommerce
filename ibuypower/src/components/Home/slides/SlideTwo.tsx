...
import slideTwo from '../../../assets/slideTwoImg.webp'
    ...
    return (
        <div>
            ...
            <div className="information">
                ...
                <p className="information-subtitle-slide-two">The faster the better. It's time for iBuyPower PC with Intel Inside and Windows 11. Let's go!</p>
